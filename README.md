...
```bash
gh attestation verify ./TimePast_0.1.1_x64-setup.exe --repo secure-artifacts/Timepast2
gh attestation verify ./TimePast_0.1.1_x64_en-US.msi --repo secure-artifacts/Timepast2
```
