...
- `TimePast_0.1.2_x64-setup.exe` for the standard installer
- `TimePast_0.1.2_x64_en-US.msi` for MSI deployment
...
```bash
gh attestation verify ./TimePast_0.1.2_x64-setup.exe --repo secure-artifacts/Timepast2
gh attestation verify ./TimePast_0.1.2_x64_en-US.msi --repo secure-artifacts/Timepast2
```
